...
I've worked in geoscience research for more than 5 years. I have expertise on large datasets at global-scale (NOAA-GFS, Era-Interim, ESA-GlobWave, Landsat, Sentinels) geo formats (GeoTIFF, NetCDF, GRIB) programming languages (Python, Matlab, Fortran, C++, learning Node.js), big data geosciences portals ([Google Earth Engine](https://earthengine.google.com/), [Pangeo](http://pangeo-data.org/), [OpenStreetMap](https://www.openstreetmap.org/)) and workflow automation & orchestration.
